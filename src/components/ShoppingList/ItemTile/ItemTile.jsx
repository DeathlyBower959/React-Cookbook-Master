                    ...
                    <div className="col-sm-10" style={{ paddingLeft: '0px', paddingTop: '3px' }}>
                        <div className="card-body" style={{ paddingBottom: '0px' }}>
                            <div style={{ display: 'flex' }}>
                                <h5 className="card-title" style={{ marginLeft: '10px' }}>{Math.ceil(amount * 10) / 10} {unit}</h5>
                            ...
                            <div style={{ display: 'flex' }}>
                                ...
                                <img width='30px' style={{ cursor: 'pointer', margin: '0px 0px 0px 5px' }} src={amount <= 0.1 ? deleteLogo : minusLogo} onClick={() => deleteItem(id)} alt='Not found... :(' />
                            </div>
                        </div>
                    </div>
                </div>
